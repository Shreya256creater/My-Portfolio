...
//                                             <div className='felx justify-between items-start mb-2'>
//                                                  <h3 className='text-xl font-semibold'>{data.role}</h3>
//                                                  <span className='px-3 py-1 bg-purple/20 text-purpple rounded-full text-xs md:text-sm'>{data.duration}</span>
//                                             </div>
